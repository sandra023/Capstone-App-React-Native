...
export default class FinishedEditProfileScreen extends Component {
  constructor(props){
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.interestRows}>            
        ...
        {this.state.currentUser.health === "true" ? <Image source={require('../images/interestTags/healthTag.png')} style={styles.interestTag}/> : null}
